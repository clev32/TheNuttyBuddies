...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="/FinalProject/index.html"><img src ="images/logo_transparent_background.png" width="75" height="75"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" id= "indexLink" href="/FinalProject/index.html">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="galleryLink" href="/FinalProject/photoGallery/gallery.html">Photo Gallery</a>
      </li>
        <li class="nav-item">
        <a class="nav-link" href="/FinalProject/event-calendar-evo/event-calendar-evo/calendar.html">Calendar</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="/FinalProject/recipe.html">All recipes</a>
